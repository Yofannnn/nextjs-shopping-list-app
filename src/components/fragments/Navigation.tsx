...
const Navigation = () => {
  ...
  return (
    <FloatingNav>
      <nav className="relative z-[999] w-full h-[65px] flex justify-between items-center backdrop-blur">
        <h1 className="syncopate text-lg md:text-xl font-semibold ml-4">
          NEXCART
        </h1>
        <div className="w-[50%] flex justify-end items-center gap-4 mr-4">
          <ul className="w-[75%] flex justify-around items-center">
            <li>
              <Link href="/" className="syne text-sm md:text-base">
                Home
              </Link>
            </li>
            <li>
              <Link href="/create" className="syne text-sm md:text-base">
                Create
              </Link>
            </li>
            <li>
              <Link href="/ai" className="syne text-sm md:text-base">
                Ai
              </Link>
            </li>
          </ul>
