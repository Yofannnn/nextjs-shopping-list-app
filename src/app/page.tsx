  ...
  return (
    <>
        ...
        <div className="w-full h-svh flex flex-col justify-center items-center gap-4 p-3 md:p-4">
          ...
          <div className="flex justify-center items-center gap-2 mt-10">
            <BlurFade delay={0.4} once={true}>
              <Link
                href="/create"
                className="px-5 py-2 lg:px-8 lg:py-4 text-xs md:text-sm lg:text-base bg-foreground text-background rounded-full inline-flex items-center justify-center group"
              >
                Get Started
            ...
            <BlurFade delay={0.4} once={true}>
              <Link
                href="/ai"
                className="px-5 py-2 lg:px-8 lg:py-4 text-xs md:text-sm lg:text-base hover:bg-muted rounded-full inline-flex items-center justify-center group"
              >
                Try Gemini Ai
                <ChevronRight className="size-3 md:size-4 lg:size-5 group-hover:translate-x-1 transition-all duration-500" />
              </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 lg:gap-8 px-6 lg:px-10 py-20">
          ...
          <div className="col-span-1">
            <BlurFade delay={0.2} blur="0px">
              <h2 className="text-center md:text-start text-3xl md:text-4xl lg:text-5xl font-semibold mb-4">
                What is NEXCART
              </h2>
            </BlurFade>
            <BlurFade delay={0.4} blur="0px">
              <p className="text-sm lg:text-base text-muted-foreground">
                NEXCART is web application built with Next.js and styled using
                NextUI and UI Shadcn, provides a comprehensive shopping list
                management tool. Developed in TypeScript, it allows users to
                add, delete, update, and view shopping items, with data stored
                in IndexedDB. The app supports dark and light themes, various
                sorting methods, and currency format settings for international
                users. It also includes undo-redo functionality and a trash bin
                for safely managing deleted items. A notable feature is the
                integration with Gemini AI, which enables users to add items to
                their shopping list directly from Gemini AI responses, enhancing
                the list management experience. The app&apos;s user-friendly
      ...
      <footer className="-z-10 fixed bottom-0 w-full h-[70vh] overflow-hidden flex justify-center items-center">
        <h1 className="text-[18vmax] font-extrabold">NEXCART</h1>
